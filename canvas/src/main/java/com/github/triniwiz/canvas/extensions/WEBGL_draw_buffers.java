...
public class WEBGL_draw_buffers {
    ...
    public int DRAW_BUFFER1_WEBGL = Constants.GL_DRAW_BUFFER0_EXT;
    public int DRAW_BUFFER2_WEBGL = Constants.GL_DRAW_BUFFER0_EXT;
    public int DRAW_BUFFER3_WEBGL = Constants.GL_DRAW_BUFFER0_EXT;
    public int DRAW_BUFFER4_WEBGL = Constants.GL_DRAW_BUFFER0_EXT;
    public int DRAW_BUFFER5_WEBGL = Constants.GL_DRAW_BUFFER0_EXT;
    public int DRAW_BUFFER6_WEBGL = Constants.GL_DRAW_BUFFER0_EXT;
    public int DRAW_BUFFER7_WEBGL = Constants.GL_DRAW_BUFFER0_EXT;
    public int DRAW_BUFFER8_WEBGL = Constants.GL_DRAW_BUFFER0_EXT;
    public int DRAW_BUFFER9_WEBGL = Constants.GL_DRAW_BUFFER0_EXT;
    public int DRAW_BUFFER10_WEBGL = Constants.GL_DRAW_BUFFER0_EXT;
    public int DRAW_BUFFER11_WEBGL = Constants.GL_DRAW_BUFFER0_EXT;
    public int DRAW_BUFFER12_WEBGL = Constants.GL_DRAW_BUFFER0_EXT;
    public int DRAW_BUFFER13_WEBGL = Constants.GL_DRAW_BUFFER0_EXT;
    public int DRAW_BUFFER14_WEBGL = Constants.GL_DRAW_BUFFER0_EXT;
    public int DRAW_BUFFER15_WEBGL = Constants.GL_DRAW_BUFFER0_EXT;
